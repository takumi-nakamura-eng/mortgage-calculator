...
export default function CantileverCalculator() {
  const {
    ...
    defaultDeflectionN: 200,
    toolId: 'cantilever',
    toolName: '片持ち梁計算',
    analyticsToolId: 'cantilever',
    calculateBeam: calcCantileverBeam,
    buildFormulaSteps: buildCantileverFormulaSteps,
  });
  ...
  return (
    ...
    <BeamCalculatorLayout
      diagram={<CantileverDiagram loadCase={loadCase} spanLabel={spanLabel} loadLabel={loadLabelForDiagram} />}
